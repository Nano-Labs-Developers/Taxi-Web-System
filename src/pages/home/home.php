    ...
    <div class="container px-4 py-5" id="hanging-icons">
        ...
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
            <div class="col d-flex align-items-start">
                ...
                <div>
                    <h2>Ride</h2>
                    <p>PickMe Ride-Hailing includes the largest fleet of vehicles in Sri Lanka offering both on-demand and pre-booking features at the best rates, including TUK-TUKs Flex, Minis, Cars, Minivans, and Vans offering you comfort, convenience and safety, covering the entire island nation.</p>
                </div>
            </div>
            <div class="col d-flex align-items-start">
                <div class="icon-square bg-light text-dark flex-shrink-0 me-3">
                ...
                <div>
                    <h2>Flash</h2>
                    <p>PickMe Flash is a pioneering, on-demand, speedy parcel delivery platform, that enables a seamless package delivery experience, tapping into the largest live fleet of available vehicles in the city.</p>
                </div>
            </div>
            <div class="col d-flex align-items-start">
                <div class="icon-square bg-light text-dark flex-shrink-0 me-3">
