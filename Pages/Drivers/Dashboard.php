...
<body class="bg-light">
    <main>
        <?php include_once "../../components/driver/sidebar.php"; ?>
                        ...
                        <?php
                            ...
                            if (!isset($_SESSION['availability'])) {
                                ...
                                if ($availability == "Available") {
                                    echo '<h1 class="card-title text-success">Available</h1>';
                                }
                                else if ($availability == "Busy") {
                                    echo '<h1 class="card-title text-danger">Busy</h1>';
                                }
                                else if ($availability == "Offline") {
                                    echo '<h1 class="card-title text-muted">Offline</h1>';
                                }
                            }
                            else {
                                echo '<h1 class="card-title text-muted">404</h1>';
                            }
                        
                        ?>
                        <p class="card-text fs-5">Availability</p>
                    </div>
                </div>
                <div class="card text-dark bg-light mb-3 shadow rounded me-3" style="width: 15rem; max-width: 18rem;">
                    <div class="card-body my-4">
