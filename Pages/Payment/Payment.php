...
<body>
    ...
    <div class="container mt-5 px-5">
        <div class="mb-4">
            <h2>Confirm order and pay</h2><span>please make the payment, after that you can your dashboard for more.</span>
        </div>
        <div class="row">
            <div class="col-md-8">
                <div class="card p-3">
                ...
                <div class="mt-4 mb-4 d-flex justify-content-between"> <span>Previous step</span> <button class="btn btn-success px-3">Pay Now</button> </div>
            </div>
            <div class="col-md-4">
                <div class="card bg-warning p-3 text-white mb-3"> <span>You have to pay</span>
                    <div class="d-flex flex-row align-items-end mb-3">
                        <h1 class="mb-0 yellow">Rs. 4500</h1> <span>.00</span>
                    </div>
                    <a href="#" class="yellow decoration">FAQs</a>
                    <div class="hightlight"> <span>100% Guaranteed support</span> </div>
                </div>
            </div>
        </div>
    </div>
